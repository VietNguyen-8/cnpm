...
<div class="card card-outline card-primary">
	<div class="card-header">
		<h3 class="card-title">Danh sách loại nghỉ</h3>
...
<script>
	$(document).ready(function(){
		$('.delete_data').click(function(){
			_conf("Bạn có chắc chắn muốn xóa không?","delete_leave_type",[$(this).attr('data-id')])
		})
		$('.edit_data').click(function(){
			uni_modal("<i class='fa fa-edit'></i> Sửa",'maintenance/manage_leave_type.php?id='+$(this).attr('data-id'))
		})
		$('#create_new').click(function(){
			uni_modal("<i class='fa fa-plus'></i> Thêm",'maintenance/manage_leave_type.php')
		})
		$('.table').dataTable();
	})
