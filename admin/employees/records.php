...
<div class="card">
    <div class="card-body">
        <div class="w-100 d-flex justify-content-end mb-3">
            ...
            <?php endif; ?>
            <a href="javascript:void(0)" class="btn btn-flat btn-success ml-3" id="print"><span class="fas fa-print"></span> In</a>
        </div>
        <div id="print_out">
                ...
                <td width="80%" class='boder-0 align-bottom'>
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="d-flex w-max-100">
                                <label class="float-left w-auto whitespace-nowrap">Tên:</label>
        ...
        <div class="row">
            <div class="col-md-4 col-sm-12">
                <div class="callout border-0">
                    ...
                    <h5 class="mb-2">Tiền cho phép</h5>
                    <table class="table table-hover ">
                        ...
                        <thead>
                            <tr>
                                <th class="py-1 px-2">Loại</th>
                                <th class="py-1 px-2">Tiền</th>
                                <th class="py-1 px-2">Khả dụng</th>
                            </tr>
                        </thead>
                        <tbody>
                        <?php 
            ...
            <div class="col-md-8 col-sm-12">
                <div class="callout border-0">
                    ...
                    <table class="table-stripped table">
                        ...
                        <thead>
                            <tr>
                                <th class="p-1">Loại nghỉ phép</th>
                                <th class="p-1">Ngày</th>
                                <th class="p-1">Số ngày nghỉ</th>
