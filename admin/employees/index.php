				...
				<tbody>
					...
					?>
						<tr>
							...
							<td >
								<p class="m-0 ">
									<b>Phòng ban: </b><?php echo isset($dept_arr[$row['department_id']]) ? $dept_arr[$row['department_id']] : 'N/A' ?><br>
									<b>Chức vụ: </b><?php echo isset($desg_arr[$row['designation_id']]) ? $desg_arr[$row['designation_id']] : 'N/A' ?><br>
								</p>
							</td>
							<td align="center">
								 <button type="button" class="btn btn-flat btn-default btn-sm dropdown-toggle dropdown-icon" data-toggle="dropdown">
				                  ...
				                  <div class="dropdown-menu" role="menu">
				                    ...
				                    <div class="dropdown-divider"></div>
									<a class="dropdown-item reset_password" href="javascript:void(0)" data-id="<?php echo $row['id'] ?>"><span class="fa fa-key text-primary"></span> Reser mật khẩu</a>
				                    <div class="dropdown-divider"></div>
...
<script>
	$(document).ready(function(){
		$('.delete_data').click(function(){
			_conf("Bạn có chắc chắn muốn xóa người dùng ko ?","delete_user",[$(this).attr('data-id')])
		})
		$('.reset_password').click(function(){
			_conf("Bạn có chắc chắn muốn thay đổi mật khẩu của người dùng ko ?","reset_password",[$(this).attr('data-id')])
		})
		$('.table').dataTable();
	})
