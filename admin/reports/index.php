            ...
            <div class="col-2 row align-items-end pb-1">
                <div class="w-100">
                    <div class="form-group d-flex justify-content-between align-middle">
                        <button class="btn btn-flat btn-default bg-lightblue" type="button" id="filter"><i class="fa fa-filter"></i> Tìm</button>
			...
			<table class="table table-hover table-stripped">
				...
				<tbody>
					...
					?>
						<tr>
							...
							<td>
                                ...
                                <small><b>Tên: </b><?php echo $row['name'] ?></small>
                            </td>
					...
					<?php if($qry->num_rows <=0 ): ?>
                        <tr>
                            <th class="text-center" colspan='6'> Chưa có bản ghi nào</th>
                        </tr>
					<?php endif; ?>
				</tbody>
			</table>
