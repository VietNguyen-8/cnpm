...
<div class="card card-outline card-info">
				...
				<div class="col-6">
					...
					<div class="form-group">
						...
						<select id="type" name="type" class="form-control rounded-0">
							<option value="1" <?php echo (isset($type) && $type ==1)?'selected' : '' ?>>Cả ngày</option>
							<option value="2" <?php echo (isset($type) && $type ==2)?'selected' : '' ?>>Nửa ngày</option>
						</select>
					</div>
					<div class="form-group">
						<label for="date_start" class="control-label">Bắt đầu</label>
					...
					<div class="form-group">
						<label for="date_end" class="control-label">Kết thúc</label>
					...
					<div class="form-group">
						<label for="leave_days" class="control-label">Số ngày</label>
	...
	<div class="card-footer">
		<button class="btn btn-flat btn-primary" form="leave_application-form">Lưu</button>
		<a class="btn btn-flat btn-default" href="?page=leave_applications">Hủy</a>
	</div>
</div>
<script>
