    ...
    <form action="" id="update-status-form">
            ...
            <div class="form-group">
                ...
                <select id="status" name="status" class="form-control rounded-0">
                    ...
                    <option value="1" <?php echo (isset($status) && $status ==1)?'selected' : '' ?>>Chấp thuận</option>
                    <option value="2" <?php echo (isset($status) && $status ==2)?'selected' : '' ?>>Từ chối</option>
                    <option value="3" <?php echo (isset($status) && $status ==3)?'selected' : '' ?>>Hủy</option>
                </select>
            </div>
    </form>
</div>
