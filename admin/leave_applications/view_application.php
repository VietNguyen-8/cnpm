...
<div class="container-fluid">
    ...
    <p class="m-0"><b>ID: </b> <br><span class="mx-2"><?php echo $employee_id ?></span></p>
    <p class="m-0"><b>Tên: </b> <br><span class="mx-2"><?php echo $name ?></span></p>
    <?php endif; ?>
    <p class="m-0"><b>Loại nghỉ phép: </b> <br><span class="mx-2"><?php echo $code.' - '.$lname ?></span></p>
    <p class="m-0"><b>Ngày: </b> <br><span class="mx-2">
    <?php
    ...
    <p class="m-0"><b>Ngày xin nghỉ: </b> <br><span class="mx-2"><?php echo $leave_days ?></span></p>
    <p class="m-0"><b>Lý do: </b><br><span class="mx-2"><?php echo $reason ?></span></p>
    <p><b>Status</b><br>
    <?php if($status == 1): ?>
        <span class="badge badge-success mx-2">Chấp thuận</span>
    <?php elseif($status == 2): ?>
        <span class="badge badge-danger mx-2">Từ chối</span>
    <?php elseif($status == 3): ?>
        <span class="badge badge-danger mx-2">Hủy</span>
    <?php else: ?>
        <span class="badge badge-primary mx-2">Chờ xử lý</span>
    <?php endif; ?>
    </p>
